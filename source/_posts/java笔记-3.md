...
![](/images/java/垃圾回收-3.png)

在回收前将存活的对象复制到另一边去。然后再回收垃圾对象，回收完就类似下面的样子：

![](/images/java/垃圾回收-4.png)
...
![](/images/java/垃圾回收-5.png)

下图图表示的第一阶段：标记出存活对象和垃圾对象

![](/images/java/垃圾回收-6.png)

白色空间表示被清理后的垃圾。
下面就开始进行整理：

![](/images/java/垃圾回收-7.png)
