...
![](/images/java/限流-1.jpg)

这个算法虽然简单，但是有一个十分致命的问题，那就是临界问题，我们看下图：

![](/images/java/限流-2.jpg)
...
![](/images/java/小顶堆-2.png)

将3添加到堆的最后位置：

![](/images/java/小顶堆-3.png)

执行上浮操作，将3上浮到正确位置：

![](/images/java/小顶堆-4.png)
...
![](/images/java/小顶堆-5.png)

经过几轮下沉后：

![](/images/java/小顶堆-6.png)
...
![](/images/java/rabbitmq_delayed_message_exchange.jpg)
